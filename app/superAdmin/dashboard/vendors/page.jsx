...
import { deleteAdmin, deleteVendor } from '../../../actions/deleteVendor'
          ...
          <tr key={index} className="hover:bg-gray-50">
            ...
            <td className="border border-gray-300 px-4 py-2">{e.phone}</td>
                <td className="border border-gray-300 px-4 py-2">
                        ...
                        <button onClick={()=>deleteVendor(e.id)}   className="flex items-center justify-center w-10 h-10 bg-red-500 hover:bg-red-600 rounded-full transition duration-200">
